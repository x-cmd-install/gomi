...
[![x-cmd/install — gomi Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/gomi.svg?lang=zh)](https://x-cmd.com/install/gomi)
...
- **Star**: 572 · **Fork**: 16 · **开放 issue**: 43 · **贡献者**: 9

## 累计统计

- **发布数**: 34 · **已合并 PR**: 83 · **开放 PR**: 0 · **已关闭 issue**: 41 · **开放 issue**: 2 · **提交数**: 535
...
| last180d | 2026-03-30 | 1 | 11 | 0 | 2 | 2 | 32 |
| 360d | 2025-10-01 | 3 | 21 | 0 | 5 | 2 | 53 |
| last720d | 2024-10-06 | 19 | 71 | 0 | 19 | 2 | 399 |
...
gomi 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `gomi` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/gomi.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260926.yml` · 2026-09-26T05:01:59Z._
